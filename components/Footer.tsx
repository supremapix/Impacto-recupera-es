...
import { Phone, Mail, Instagram, MapPin, ChevronRight, Facebook, Linkedin, ShieldCheck, Heart } from 'lucide-react';
...
export function SupremaCredit() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6 pt-4 border-t border-slate-800/50 flex justify-center items-center">
      <div className="bg-slate-950/70 border border-slate-800/80 rounded-full px-6 py-2.5 shadow-lg flex items-center justify-center transition-all duration-300 hover:shadow-[0_0_15px_rgba(90,111,166,0.25)]">
  ...
  return (
    <footer className="relative bg-[#0d1017] text-white pt-16 md:pt-20 pb-12 border-t border-slate-800/80 overflow-hidden">
      ...
      <Container className="relative z-10">
        ...
        {/* Créditos Oficiais de Desenvolvimento */}
        <SupremaCredit />
      </Container>
    </footer>
  );
